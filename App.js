...
function HomeStackScreen() {
  return (
    <HomeStack.Navigator screenOptions={{headerShown: false}}>
      ...
      <HomeStack.Screen name="StoreDetails" component={StoreDetails} Options={{ header: () => true }} />
      <HomeStack.Screen name="UserOption" component={UserOption} Options={{ header: () => true }} />
      <HomeStack.Screen name="Help" component={Help} Options={{ header: () => true }} />
      <HomeStack.Screen name="SearchProduct" component={SearchProduct} Options={{ header: () => true }} />
      <HomeStack.Screen name="FreqentSearch" component={FreqentSearch} Options={{ header: () => true }} />
      <HomeStack.Screen name="CategoryModel" component={CategoryModel} Options={{ header: () => true }} />
      <HomeStack.Screen name="CheckOut" component={CheckOut} Options={{ header: () => true }} />
      <HomeStack.Screen name="Deals" component={Deals} Options={{ header: () => true }} />
      <HomeStack.Screen name="Login" component={Login} Options={{ header: () => true }} /> 
      <HomeStack.Screen name="NumberOtp" component={NumberOtp} Options={{ header: () => true }} />
      <HomeStack.Screen name="UserDashboard" component={UserDashboard} Options={{ header: () => true }} />
      <HomeStack.Screen name="Actionsheet" component={Actionsheet} Options={{ header: () => true }} />
    </HomeStack.Navigator>
  );
}
...
function OrderStackScreen() {
  return (
    <OrderStack.Navigator screenOptions={{headerShown: false}}>
      ...
      <OrderStack.Screen name="CheckOut" component={CheckOut} Options={{ header: () => true }} />
      <OrderStack.Screen name="Payment" component={Payment} Options={{ header: () => true }} />
      <OrderStack.Screen name="ReOrder" component={ReOrder} Options={{ header: () => true }} />
      <OrderStack.Screen name="Success" component={Success} Options={{ header: () => true }} />
      <OrderStack.Screen name="ReOrderCheckout" component={ReOrderCheckout} Options={{ header: () => true }} />
      <OrderStack.Screen name="ScheduleOrder" component={ScheduleOrder} Options={{ header: () => true }} />
...
function BagStackScreen() {
  return (
    <BagStack.Navigator screenOptions={{headerShown: false}}>
      ...
      <BagStack.Screen name="CheckOut" component={CheckOut} Options={{ header: () => true }} />
      <BagStack.Screen name="Payment" component={Payment} Options={{ header: () => true }} />
  ...
  "tabBarStyle": [
    ...
    null
      ...
      >
          ...
          options={{
                ...
                tabBarIcon: ({ focused, color, size }) => (
                  <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                    <Ionicons name='home' resizeMode='contain' size={size} color={color}
                      // style={{ tintColor: focused ? '#EB3223' : 'gray' }}
                       />
                  </View>)
          }} />
        <Tab.Screen name="OrderTab" component={OrderStackScreen}
          options={{
            tabBarLabel:"Order",
                tabBarIcon: ({ focused, color, size }) => (
                  <View style={{ alignItems: 'center', justifyContent: 'center' }}>
        ...
        <Tab.Screen name="BagTab" component={BagStackScreen}
          options={{
            tabBarLabel:"Bag",
                tabBarIcon: ({ focused, color, size }) => (
                  <View style={{ alignItems: 'center', justifyContent: 'center' }}>
        ...
        <Tab.Screen name="NotificationTab" component={NotificationStackScreen} options={{

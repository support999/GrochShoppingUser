  ...
  return (        
          <View style={styles.storeNearYou}>
            ...
            <View style={styles.storeNearYouHeader}>
              <Text style={styles.storeNearYouHeaderFevorit}>All Stores Near You</Text>
            ...
            <TouchableOpacity style={styles.storeNearYouItem} onPress={() => navigation.navigate('StoreDetails')}>
              ...
              <View style={styles.storeNearItemDetails}>
                <View style={styles.storeNearItemInfo}>
                  <Text style={styles.storeNearItemName}>Jain kirana store Jain kirana store Jain kirana store</Text>

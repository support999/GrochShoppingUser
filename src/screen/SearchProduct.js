...
const SearchProduct = ({navigation}) => {
  ...
  return (        
      <ScrollView style={styles.main}>
          ...
          <View style={styles.category}>
            <View style={styles.categorySectionHeader}>
              <Text style={styles.categorySectionHeaderCategory}>Recommended Products</Text>
              <Text style={styles.categorySectionHeaderBtn}>See All</Text>
            </View>
            ...
            <View style={styles.categorySectionGrid}>
              <TouchableOpacity style={styles.recomSectionItem}>
                ...
                <Image style={styles.RecomItemLogo} source={require('./../assets/banana.png')} ></Image>
                </View>
                  {/* <Text style={styles.categoryItemName}>Vegetables</Text> */}
              </TouchableOpacity>
              ...
              <TouchableOpacity style={styles.recomSectionItem}>
                <View style={[styles.recomItemLogoBG,]}>
                <Image style={styles.RecomItemLogo} source={require('./../assets/redPaper.png')} ></Image>
                </View>
                  {/* <Text style={styles.categoryItemName}>Vegetables</Text> */}
              </TouchableOpacity>
              ...
              <TouchableOpacity style={styles.recomSectionItem}>
                <View style={[styles.recomItemLogoBG, ]}>
                <Image style={styles.RecomItemLogo} source={require('./../assets/product1.png')} ></Image>
                </View>
                  {/* <Text style={styles.categoryItemName}>Vegetables</Text> */}
              </TouchableOpacity>
